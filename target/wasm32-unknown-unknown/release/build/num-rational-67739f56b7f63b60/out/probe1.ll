...
define hidden { i8*, i32* } @_ZN4core3fmt10ArgumentV13new17hcb2d41b62e6cd56dE(i32* align 4 dereferenceable(4) %x, i1 (i32*, %"std::fmt::Formatter"*)* nonnull %f) unnamed_addr #1 {
start:
...
; Function Attrs: inlinehint nounwind
define internal void @_ZN4core3fmt9Arguments6new_v117h6a62150d66d13d34E(%"std::fmt::Arguments"* noalias nocapture sret(%"std::fmt::Arguments") dereferenceable(24) %0, [0 x { [0 x i8]*, i32 }]* nonnull align 4 %pieces.0, i32 %pieces.1, [0 x { i8*, i32* }]* nonnull align 4 %args.0, i32 %args.1) unnamed_addr #0 {
start:
...
; Function Attrs: nounwind
define hidden void @"_ZN4core3ptr42drop_in_place$LT$alloc..string..String$GT$17h4e820d500b75ddb0E"(%"std::string::String"* %_1) unnamed_addr #1 {
start:
  %0 = bitcast %"std::string::String"* %_1 to %"std::vec::Vec<u8>"*
; call core::ptr::drop_in_place<alloc::vec::Vec<u8>>
  call void @"_ZN4core3ptr46drop_in_place$LT$alloc..vec..Vec$LT$u8$GT$$GT$17h3ff1c02a539a706bE"(%"std::vec::Vec<u8>"* %0)
  br label %bb1
...
; Function Attrs: nounwind
define hidden void @"_ZN4core3ptr46drop_in_place$LT$alloc..vec..Vec$LT$u8$GT$$GT$17h3ff1c02a539a706bE"(%"std::vec::Vec<u8>"* %_1) unnamed_addr #1 {
start:
; call <alloc::vec::Vec<T,A> as core::ops::drop::Drop>::drop
  call void @"_ZN70_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17hae82ac5990ca2a3dE"(%"std::vec::Vec<u8>"* align 4 dereferenceable(12) %_1)
  br label %bb2
...
; call core::ptr::drop_in_place<alloc::raw_vec::RawVec<u8>>
  call void @"_ZN4core3ptr53drop_in_place$LT$alloc..raw_vec..RawVec$LT$u8$GT$$GT$17hb033db92fbc52b22E"({ i8*, i32 }* %0)
  br label %bb1
}

; core::ptr::drop_in_place<alloc::raw_vec::RawVec<u8>>
; Function Attrs: nounwind
define hidden void @"_ZN4core3ptr53drop_in_place$LT$alloc..raw_vec..RawVec$LT$u8$GT$$GT$17hb033db92fbc52b22E"({ i8*, i32 }* %_1) unnamed_addr #1 {
start:
; call <alloc::raw_vec::RawVec<T,A> as core::ops::drop::Drop>::drop
  call void @"_ZN77_$LT$alloc..raw_vec..RawVec$LT$T$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h3fc0fcc573a44f83E"({ i8*, i32 }* align 4 dereferenceable(8) %_1)
  br label %bb1
...
; Function Attrs: inlinehint nounwind
define hidden i8* @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$10as_mut_ptr17hba77e212ad495511E"(%"std::vec::Vec<u8>"* align 4 dereferenceable(12) %self) unnamed_addr #0 {
start:
  %_2 = bitcast %"std::vec::Vec<u8>"* %self to { i8*, i32 }*
; call alloc::raw_vec::RawVec<T,A>::ptr
  %ptr = call i8* @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$3ptr17h77c23a6cf5d36c40E"({ i8*, i32 }* align 4 dereferenceable(8) %_2)
  br label %bb1
...
; alloc::alloc::dealloc
; Function Attrs: inlinehint nounwind
define internal void @_ZN5alloc5alloc7dealloc17h6b32ac64a55c1f01E(i8* %ptr, i32 %0, i32 %1) unnamed_addr #0 {
start:
...
; Function Attrs: nounwind
define hidden void @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$14current_memory17h26139b60e039488dE"(%"std::option::Option<(std::ptr::NonNull<u8>, std::alloc::Layout)>"* noalias nocapture sret(%"std::option::Option<(std::ptr::NonNull<u8>, std::alloc::Layout)>") dereferenceable(12) %0, { i8*, i32 }* align 4 dereferenceable(8) %self) unnamed_addr #1 {
start:
...
; call core::alloc::layout::Layout::from_size_align_unchecked
  %10 = call { i32, i32 } @_ZN4core5alloc6layout6Layout25from_size_align_unchecked17h0eb3d4279e970bb1E(i32 %size, i32 %8)
...
; Function Attrs: inlinehint nounwind
define hidden i8* @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$3ptr17h77c23a6cf5d36c40E"({ i8*, i32 }* align 4 dereferenceable(8) %self) unnamed_addr #0 {
start:
...
; Function Attrs: inlinehint nounwind
define internal void @"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17ha0c3ff1687dd095dE"(%"std::alloc::Global"* nonnull align 1 %self, i8* nonnull %ptr, i32 %0, i32 %1) unnamed_addr #0 {
start:
  %2 = alloca {}, align 1
  %layout = alloca { i32, i32 }, align 4
...
; call alloc::alloc::dealloc
  call void @_ZN5alloc5alloc7dealloc17h6b32ac64a55c1f01E(i8* %_6, i32 %_8.0, i32 %_8.1)
  br label %bb5
...
; Function Attrs: nounwind
define hidden void @"_ZN70_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17hae82ac5990ca2a3dE"(%"std::vec::Vec<u8>"* align 4 dereferenceable(12) %self) unnamed_addr #1 {
start:
; call alloc::vec::Vec<T,A>::as_mut_ptr
  %_3 = call i8* @"_ZN5alloc3vec16Vec$LT$T$C$A$GT$10as_mut_ptr17hba77e212ad495511E"(%"std::vec::Vec<u8>"* align 4 dereferenceable(12) %self)
  br label %bb1
...
; Function Attrs: nounwind
define hidden void @"_ZN77_$LT$alloc..raw_vec..RawVec$LT$T$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h3fc0fcc573a44f83E"({ i8*, i32 }* align 4 dereferenceable(8) %self) unnamed_addr #1 {
start:
  %_2 = alloca %"std::option::Option<(std::ptr::NonNull<u8>, std::alloc::Layout)>", align 4
  %0 = alloca {}, align 1
; call alloc::raw_vec::RawVec<T,A>::current_memory
  call void @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$14current_memory17h26139b60e039488dE"(%"std::option::Option<(std::ptr::NonNull<u8>, std::alloc::Layout)>"* noalias nocapture sret(%"std::option::Option<(std::ptr::NonNull<u8>, std::alloc::Layout)>") dereferenceable(12) %_2, { i8*, i32 }* align 4 dereferenceable(8) %self)
  br label %bb1
...
; call <alloc::alloc::Global as core::alloc::Allocator>::deallocate
  call void @"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17ha0c3ff1687dd095dE"(%"std::alloc::Global"* nonnull align 1 %_7, i8* nonnull %ptr, i32 %layout.0, i32 %layout.1)
  br label %bb4
...
; call core::fmt::ArgumentV1::new
  %0 = call { i8*, i32* } @_ZN4core3fmt10ArgumentV13new17hcb2d41b62e6cd56dE(i32* align 4 dereferenceable(4) %arg0, i1 (i32*, %"std::fmt::Formatter"*)* nonnull @"_ZN4core3fmt3num3imp55_$LT$impl$u20$core..fmt..LowerExp$u20$for$u20$isize$GT$3fmt17h6da6f17f2cf3249fE")
...
; call core::fmt::Arguments::new_v1
  call void @_ZN4core3fmt9Arguments6new_v117h6a62150d66d13d34E(%"std::fmt::Arguments"* noalias nocapture sret(%"std::fmt::Arguments") dereferenceable(24) %_3, [0 x { [0 x i8]*, i32 }]* nonnull align 4 bitcast (<{ i8*, [4 x i8] }>* @alloc2 to [0 x { [0 x i8]*, i32 }]*), i32 1, [0 x { i8*, i32* }]* nonnull align 4 %_7.0, i32 1)
  br label %bb2

bb2:                                              ; preds = %bb1
; call alloc::fmt::format
  call void @_ZN5alloc3fmt6format17h32bde061c46b8f80E(%"std::string::String"* noalias nocapture sret(%"std::string::String") dereferenceable(12) %res, %"std::fmt::Arguments"* noalias nocapture dereferenceable(24) %_3)
  br label %bb3
...
; call core::ptr::drop_in_place<alloc::string::String>
  call void @"_ZN4core3ptr42drop_in_place$LT$alloc..string..String$GT$17h4e820d500b75ddb0E"(%"std::string::String"* %_1)
  br label %bb4
...
; alloc::fmt::format
; Function Attrs: nounwind
declare dso_local void @_ZN5alloc3fmt6format17h32bde061c46b8f80E(%"std::string::String"* noalias nocapture sret(%"std::string::String") dereferenceable(12), %"std::fmt::Arguments"* noalias nocapture dereferenceable(24)) unnamed_addr #1
